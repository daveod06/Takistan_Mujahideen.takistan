...
fnc_AirmobileTrigger =
{
	...
	private _side = west;
	private _faction = "SovietArmy_OKSVA"; // FIXME
	private _category = "Infantry"; // FIXME
	private _transportType = "uns_UH1D_m60_light";
	private _attackType = selectRandom ["uns_UH1C_M21_M158"]; // FIXME
	private _squadType = selectRandom [""]; // FIXME
